...
library(ggplot2)
ggplot(dataset, aes(x = Age, y = Total_Bilirubin)) +
  geom_bar(stat = "identity", fill = "steelblue") +
  labs(x = "Age", y = "Total Bilirubin", title = "Age vs. Total Bilirubin Bar Plot")
```
we can see from the plot that age seems to be a factor in the increase of total bilirubin
## data preprocessing
...
>>>>>>> 9f98202bd29cf61a4093b9903479ae7c3c855872
