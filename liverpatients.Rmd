...
# create histogram to see the number of liver patients patients
```{r}
...
we can see from the plot that patients diagnosed with liver disease are 2x patients not diagnosed with liver disease in the dataset
